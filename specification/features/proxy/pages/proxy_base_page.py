...
from specification.features.proxy.helpers import bp_custom_expected_conditions
from specification.features.proxy.locators.footer_locators import FooterLocators
from specification.features.proxy.locators.header_locators import HeaderLocators
from specification.features.proxy.locators.shared_locators import SharedLocators

FIELD_VALIDATION_FILEPATH = "specification/features/data/errors/field_validation.json"
...
class ProxyBasePage(BasePage):
    ...
    def verify_title_for_page_by_id(self, page_name):
        ...
        file_path = "specification/features/data/content/page_titles.json"
    ...
    def verify_url_for_page_by_id(self, page_url):
        """Verifies the title of a page based on the title stored in the page_titles.json file"""
        file_path = "specification/features/data/content/page_urls.json"
